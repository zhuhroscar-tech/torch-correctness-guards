...
from torch_correctness_guards.guards.cpu_backward_nan_tail import (  # noqa: E402
...
def test_torch_unavailable_error_is_distinct_type(monkeypatch):
    import torch_correctness_guards.guards.cpu_backward_nan_tail as core_module
